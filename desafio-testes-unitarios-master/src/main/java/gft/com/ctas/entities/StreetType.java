...
public class StreetType implements Serializable {
	...
	@Id
	@SequenceGenerator(name="STREET_TYPE_ID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="STREET_TYPE_ID_GENERATOR")
	private long id;
	...
	private BigDecimal streetTypeId;
}