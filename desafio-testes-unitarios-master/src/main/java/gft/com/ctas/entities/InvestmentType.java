...
public class InvestmentType implements Serializable {
	...
	@Id
	@SequenceGenerator(name="INVESTMENT_TYPE_ID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="INVESTMENT_TYPE_ID_GENERATOR")
	private long id;

	@Column(name="INVESTMENT_TYPE_ID")
	private BigDecimal investmentTypeId;
