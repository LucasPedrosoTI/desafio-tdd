...
public class RatingType implements Serializable {
	...
	@Id
	@SequenceGenerator(name="RATING_TYPE_ID_GENERATOR" )
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="RATING_TYPE_ID_GENERATOR")
	private long id;
	...
	private BigDecimal ratingTypeId;
